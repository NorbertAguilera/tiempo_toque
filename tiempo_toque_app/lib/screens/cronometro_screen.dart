...
class _CronometroScreenState extends State<CronometroScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final String valorToqueTxt = configProv.valorToque.toString().replaceAll(RegExp(r'\.0$'), '');
    final String valorPosteTxt = configProv.valorPoste.toString().replaceAll(RegExp(r'\.0$'), '');
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    BotonPenalizacion(
                      label: 'Toque +${valorToqueTxt}s',
                      color: Colors.orange.shade700,
                      onPressed: () => compProv.agregarToque(),
                    ),
                    BotonPenalizacion(
                      label: 'Poste +${valorPosteTxt}s',
